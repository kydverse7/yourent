...
function normalizeVehicle(label) {
  ...
  const presets = {
    ...
    'KIA SORENTO': { marque: 'Kia', modele: 'Sorento', categorie: 'suv', carburant: 'diesel', boite: 'automatique' },
...
function buildPricingMeta(label) {
  ...
  const pricePresets = {
    ...
    'KIA SORENTO': { standard: 720, tenPlus: 650, fifteenPlus: 620, thirtyPlus: 580, caution: 8000 },
