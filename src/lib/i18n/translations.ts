...
const fr: Record<string, string> = {
  ...
  'form.whatsapp': 'N° WhatsApp *',
  'form.whatsappSame': 'Mon WhatsApp est le même que mon téléphone',
  'form.email': 'Email',
...
const en: Record<string, string> = {
  ...
  'form.whatsappSame': 'My WhatsApp is the same as my phone',
  'form.email': 'Email',
...
const ar: Record<string, string> = {
  ...
  'form.phone': 'الهاتف *',
  'form.whatsapp': 'رقم واتساب *',
  'form.whatsappSame': 'رقم واتساب هو نفس رقم الهاتف',
