...
import { generateInvoicePdfForEntity } from '@/services/pdfDocumentService';
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    return apiError(error instanceof Error ? error.message : 'Génération de la facture impossible', 500);
  }
}
